...
public class GameSettings : MonoBehaviour
{
    ...
    private void Awake()
    {
        //PlayerPrefs.DeleteAll; дл€ тестировки работы уровней
    ...
    {
        if (scene.buildIndex == 0) // √лавное меню
        {
    ...
    {
        // —охран€ем только максимальный пройденный уровень
    ...
    public void LoadLevel(int level)
    {
        if (isTutorialCompleted)
        {
            // ќсновные уровни идут после туториалов
